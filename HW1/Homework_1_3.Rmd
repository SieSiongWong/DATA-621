...
lm3 <- lm(TARGET_WINS ~ ., data = subset(additional_train, select=-c(TEAM_BATTING_2B,TEAM_BASERUN_CS,TEAM_PITCHING_HR,TEAM_PITCHING_BB,TEAM_BATTING_BB,TEAM_BASERUN_SB,TEAM_BATTING_3B)))
summary(lm3)

...
From chart above we can see there are 57% missing values in TEAM_BATTING_HBP, 15% missing values in TEAM_BASERUN_CS and so on. The histogram on the left also clearly depicts the influence of missing values in the variables.

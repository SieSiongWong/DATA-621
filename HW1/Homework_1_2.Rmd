...
#min_max_accuracy <- mean(apply(select(results_df,additional_test.TARGET_WINS,results_mo#del_one), 1, min) / apply(select(results_df,additional_test.TARGET_WINS,results_model_o#ne), 1, max))  
